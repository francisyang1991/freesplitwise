...
-- CreateIndex
CREATE UNIQUE INDEX "ExpensePayer_expenseId_membershipId_key" ON "ExpensePayer"("expenseId", "membershipId");
...
-- AddForeignKey
ALTER TABLE "ExpensePayer" ADD CONSTRAINT "ExpensePayer_membershipId_fkey" FOREIGN KEY ("membershipId") REFERENCES "Membership"("id") ON DELETE CASCADE ON UPDATE CASCADE;
